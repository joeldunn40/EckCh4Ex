 ...
 * ----
 * Code is editted by Joel so starts off black and green component added
 * @author joel
 */

public class NewRandomMosaicWalk2 {
...
//        fillWithRandomColors(); // Joel: default = BLACK
        currentRow = ROWS / 2;   // start at center of window
        currentColumn = COLUMNS / 2;
        while (true) {
//            changeToRandomColor(currentRow, currentColumn); // Joel: removed
            incrementGreenColor(currentRow, currentColumn); // Joel: new green change
            randomMove();
            Mosaic.delay(5);  // Remove this line to speed things up!
        }
    }  // end main

// fillWithRandomColors() removed by Joel (not required)
//    /**
...
//    }  // end fillWithRandomColors
     ...
     * Precondition:   The specified rowNum and colNum are in the valid range
     *                 of row and column numbers.
     * Postcondition:  The square in the specified row and column will.
     * 				   have the green component incremented by 25
     *                 to a max of 255
     * @param rowNum
     * @param colNum
     */
    static void incrementGreenColor(int rowNum, int colNum) {
    	int green = Mosaic.getGreen(rowNum, colNum);
    	green += 25;
    	if (green > 255)
    		green = 255;
        Mosaic.setColor(rowNum,colNum,0,green,0);      	
    } // end incrementGreenColor
